...
from open_ts_search.algo.ccqn.components import (
...
from open_ts_search.algo.ccqn.contexts.step_context import StepContext
from open_ts_search.algo.ccqn.phases.uphill_phase import UphillPhase
from open_ts_search.algo.ccqn.phases.prfo_phase import PRFOPhase
...
class CCQNOptimizer(Optimizer):
    ...
    def step(self, f=None):
        ...
        prev_B = self.B if self.nsteps > 0 else None
        prev_mode = self.mode if self.nsteps > 0 else None
        if self.nsteps > 0:
