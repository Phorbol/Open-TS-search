class StepContext:
    def __init__(self, atoms, B, g_k, x_k, e_k, eigvals, eigvecs, trust_radius_uphill, trust_radius_saddle, cos_phi, e_vector_method, product_atoms, idpp_images, use_idpp, reactive_bonds, ic_mode, prev_pos, prev_grad, prev_energy, logfile):
        self.atoms = atoms
        self.B = B
        self.g_k = g_k
        self.x_k = x_k
